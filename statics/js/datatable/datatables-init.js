        ...
        init: function (num) {
            ...
            var oTable = $('#simpledatatable').dataTable({
                ...
                "oTableTools": {
                    ...
                    "sSwfPath": "~/statics/swf/copy_csv_xls_pdf.swf"
                },
                "language": {
                    "search": "",
                    "sLengthMenu": "_MENU_",
...
var InitiateSimpleDataTableForGiveHistory = function(){
    return {
        init: function () {
            //Datatable Initiating
            var oTable = $('#simpledatatable').dataTable({
    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                var sOut = '<table>';
                sOut += '<tr><td rowspan="5" style="padding:0 10px 0 0;"><img src="~/statics/img/avatars/' + aData[6] + '"/></td><td>Name:</td><td>' + aData[1] + '</td></tr>';
                sOut += '<tr><td>Family:</td><td>' + aData[2] + '</td></tr>';
                sOut += '<tr><td>Age:</td><td>' + aData[3] + '</td></tr>';
                sOut += '<tr><td>Positon:</td><td>' + aData[4] + '</td></tr>';
                sOut += '<tr><td>Positon:</td><td>' + aData[5] + '</td></tr>';
